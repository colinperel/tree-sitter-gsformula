...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_identifier_character_set_1, 679, lookahead)) ADVANCE(119);
      END_STATE();
    case 1:
    ...
    case 38:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(38);
      if (set_contains(sym_identifier_character_set_1, 679, lookahead)) ADVANCE(120);
      END_STATE();
    case 39:
    ...
    case 90:
      ...
      if (set_contains(sym_identifier_character_set_2, 773, lookahead)) ADVANCE(119);
      END_STATE();
    case 91:
      ACCEPT_TOKEN(sym_reference);
    ...
    case 120:
      ACCEPT_TOKEN(sym_identifier);
      if (set_contains(sym_identifier_character_set_2, 773, lookahead)) ADVANCE(120);
      END_STATE();
    default:
      return false;
  }
